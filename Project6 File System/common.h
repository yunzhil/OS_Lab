...
#define SECTOR_NUM_PER_GROUP (GROUP_SIZE / SECTOR_SIZE) // 262144

#define INODE_SIZE 0x80 // sizeof(inode_t)
#define INODE_NUM_PER_SECTOR (SECTOR_SIZE / INODE_SIZE)

#define INODE_BITMAP_SECTOR_NUM_PER_GROUP 2
#define BLOCK_BITMAP_SECTOR_NUM_PER_GROUP 8

#define INODE_SECTOR_NUM_PER_GROUP (INODE_SIZE * INODE_PER_GROUP / SECTOR_SIZE)
#define CONTROL_SECTOR_NUM_PER_GROUP (2 + INODE_BITMAP_SECTOR_NUM_PER_GROUP + BLOCK_BITMAP_SECTOR_NUM_PER_GROUP + INODE_SECTOR_NUM_PER_GROUP)
#define BLOCK_SECTOR_NUM_PER_GROUP (SECTOR_NUM_PER_GROUP - CONTROL_SECTOR_NUM_PER_GROUP)

#define INODE_PER_GROUP 0x10000 // 65536
#define BLOCK_PER_GROUP SECTOR_NUM_PER_GROUP // 262144

#define MIN_DISK_SIZE (CONTROL_SECTOR_NUM_PER_GROUP * SECTOR_SIZE)
#define MAX_DISK_SIZE

#define MIN_DISK_SIZE_FOR_DOUBLE_SUPERBLOCK (GROUP_SIZE + MIN_DISK_SIZE)
#define FIRST_SUPERBLOCK_SECTOR 0
#define SECOND_SUPERBLOCK_SECTOR SECTOR_NUM_PER_GROUP

#define INODE_BITMAP_ENTRY_SECTOR 2
#define BLOCK_BITMAP_ENTRY_SECTOR (INODE_BITMAP_ENTRY_SECTOR + INODE_BITMAP_SECTOR_NUM_PER_GROUP)
#define INODE_ENTRY_SECTOR (BLOCK_BITMAP_ENTRY_SECTOR + BLOCK_BITMAP_SECTOR_NUM_PER_GROUP)
#define DATA_ENTRY_SECTOR (INODE_ENTRY_SECTOR + INODE_SECTOR_NUM_PER_GROUP)
