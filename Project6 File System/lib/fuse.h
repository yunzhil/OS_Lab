 ...
 *
 * @param buf the help_buf passed to the readdir() operation
 * @param name the file name of the directory entry
 * @param stat file attributes, can be NULL
 * @param off offset of the next entry or zero
 * @return 1 if help_buf is full, zero otherwise
 */
...
struct fuse_operations {
	 ...
	 *
	 * The help_buf should be filled with a null terminated string.  The
	 * help_buf size argument includes the space for the terminating
	 * null character.	If the linkname is too long to fit in the
	 * help_buf, it should be truncated.	The return value should be 0
	 * for success.
	 */
	 ...
	 * passes non-zero offset to the filler function.  When the help_buf
	...
	/** Write contents of help_buf to an open file
	 *
	 * Similar to the write() method, but data is supplied in a
	 * generic help_buf.  Use fuse_buf_copy() to transfer data to
	 * the destination.
	 *
	...
	/** Store data from an open file in a help_buf
	 *
	 * Similar to the read() method, but data is stored and
	 * returned in a generic help_buf.
	 *
	 * No actual copying of data has to take place, the source
	 * file descriptor may simply be stored in the help_buf for
	 * later data transfer.
	 *
	 * The help_buf must be allocated dynamically and stored at the
	 * location pointed to by bufp.  If the help_buf contains memory
